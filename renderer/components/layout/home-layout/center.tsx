...
export function CenterContent() {
  ...
  return (
    <main
      className="flex flex-1 justify-center overflow-y-auto overflow-x-hidden pt-16"
      style={{
        backgroundImage: `url(${backgroundImage})`,
        backgroundSize: 'cover',
        backgroundRepeat: 'no-repeat',
        backgroundPosition: 'center',
        minHeight: '100vh', // ทำให้เต็มจอแนวตั้ง
        width: '100%', // ทำให้เต็มจอแนวนอน
      }}
    >
      <PageHeader className="pb-8">
        ...
        >
          ...
          <span className="hidden text-lg sm:inline">
            เราขอแนะนำให้ได้รู้จักกับระบบงานทะเบียนและวิชาการโรงเรียน (ปพ.5-6 รายปี).
          </span>
        </div>
        ...
        <span
          ...
          className="mt-4 text-center text-5xl font-bold leading-tight tracking-tighter md:text-5xl lg:leading-[1.1]"
        >
          <span className="text-gradient_indigo-purple font-bold">
            สร้างมาเพื่อคุณ
          </span>
          <span >
          งานทะเบียนและวิชาการโรงเรียน (ปพ.5-6 รายปี).
          </span>
        ...
        <span
          ...
          className=" max-w-[750px] text-center text-xl"
        >
          เป้าหมายของเรา คือ การสร้างระบบบริหารงานทะเบียนและวิชาการโรงเรียน ที่มีประสิทธิภาพ แม่นยำและรวดเร็วที่สุดเท่าที่เคยมี.
          <br />
          เริ่มใช้ระบบกันเลย!.
        </span>
        ...
        <div
          ...
          className="container mb-32 mt-28"
        >
          {' '}
          <h2 className="text-center text-sm font-semibold uppercase text-zinc-500">
            Powered by
          </h2>
          <div className="my-7 flex flex-wrap items-center justify-center gap-10 gap-y-8 text-zinc-500 lg:gap-14">
